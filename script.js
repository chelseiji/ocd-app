...
var notVisible = ['loading-screen', 'onboarding1', 'onboarding2', 'onboarding3', 'onboarding4', 'authentication', 'registration', 'signin', 'termsandconditions', 'account-setup', 'prehome-loading', 'meditation-session','meditation-timer', 'read-journal-1','balloon-pop', 'spin' ];
